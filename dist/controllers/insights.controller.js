...
exports.createInsights = exports.getAllInsights = void 0;
const use = __importStar(require("../services/insights.services"));
function getAllInsights(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const page = parseInt(req.params.page, 10) || 1;
        try {
            const [posts, totalInsights] = yield use.getAllInsightsService(page);
            const count = {
                a: page,
...
function createInsights(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield use.createInsightsService(newInsight);
...
exports.createInsights = createInsights;
